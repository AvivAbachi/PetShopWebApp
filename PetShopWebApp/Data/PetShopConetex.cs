        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Animal>().HasData(
                new Animal
                {
                    ...
                    // Category = Category!.Single(c => c.CategoryId == 1),
                    Age = 4.2,
                  ...
                  new Animal
                  {
                    ...
                    new Animal
                    {
                        AnimalId = 7,
                        Name = "Macaw",
                        // Category = Category!.Single(c => c.CategoryId == 2),
                        Age = 2.3,
                    ...
                    new Animal
                    {
                        AnimalId = 9,
                        Name = "Chameleon",
                        // Category = Category!.Single(c => c.CategoryId == 3),
                        Age = 5.6,
                    ...
                    new Animal
                    {
                        AnimalId = 11,
                        Name = "Goldfish",
                        // Category = Category!.Single(c => c.CategoryId == 4),
                        Age = 1.2,
