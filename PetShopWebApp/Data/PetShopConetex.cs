    ...
    public class PetShopConetex : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>().HasData(
                new Comment { CommentId = 1, PetId = 1, Auther = "Shira", Text = "Small Dog", CreatedDate = DateTime.Now.AddHours(-10) },
                new Comment { CommentId = 2, PetId = 3, Auther = "Aviv", Text = "British Dog", CreatedDate = DateTime.Now.AddHours(-9.85) },
                new Comment { CommentId = 3, PetId = 11, Auther = "Aviv", Text = "Gold fish is very gold", CreatedDate = DateTime.Now.AddHours(-9.27) },
                new Comment { CommentId = 4, PetId = 3, Auther = "Shira", Text = "Good for sheep", CreatedDate = DateTime.Now.AddHours(-8.96) },
                new Comment { CommentId = 5, PetId = 7, Auther = "Aviv", Text = "Cute Macaw", CreatedDate = DateTime.Now.AddHours(-8.54) },
                new Comment { CommentId = 6, PetId = 9, Auther = "Shira", Text = "Small Chameleon", CreatedDate = DateTime.Now.AddHours(-8.12) },
                new Comment { CommentId = 7, PetId = 4, Auther = "Shira", Text = "Cat with blue eyes", CreatedDate = DateTime.Now.AddHours(-7.97) },
                new Comment { CommentId = 8, PetId = 5, Auther = "Aviv", Text = "Persian Cute Cat", CreatedDate = DateTime.Now.AddHours(-7.28) },
                new Comment { CommentId = 9, PetId = 10, Auther = "Aviv", Text = "Cute tortoise", CreatedDate = DateTime.Now.AddHours(-6.96) },
                new Comment { CommentId = 10, PetId = 5, Auther = "Shira", Text = "Persian's cates are with round face and short muzzle", CreatedDate = DateTime.Now.AddHours(-6.19) },
                new Comment { CommentId = 11, PetId = 2, Auther = "Shira", Text = "White black Dog", CreatedDate = DateTime.Now.AddHours(-5.64) },
                new Comment { CommentId = 12, PetId = 8, Auther = "Aviv", Text = "Cute African Grey", CreatedDate = DateTime.Now.AddHours(-5.57) },
                new Comment { CommentId = 13, PetId = 6, Auther = "Shira", Text = "Brown Rabbit", CreatedDate = DateTime.Now.AddHours(-5.12) },
                new Comment { CommentId = 14, PetId = 9, Auther = "Aviv", Text = "Cute Chameleon", CreatedDate = DateTime.Now.AddHours(-4.87) },
                new Comment { CommentId = 15, PetId = 1, Auther = "Aviv", Text = "Cute Dog", CreatedDate = DateTime.Now.AddHours(-4.33) },
                new Comment { CommentId = 16, PetId = 8, Auther = "Shira", Text = "African Grey is grey", CreatedDate = DateTime.Now.AddHours(-4.21) },
                new Comment { CommentId = 17, PetId = 12, Auther = "Shira", Text = "Clown fish cute", CreatedDate = DateTime.Now.AddHours(-3.84) },
                new Comment { CommentId = 18, PetId = 10, Auther = "Shira", Text = "Small tortoise", CreatedDate = DateTime.Now.AddHours(-3.4) },
                new Comment { CommentId = 19, PetId = 2, Auther = "Aviv", Text = "Snow Dog", CreatedDate = DateTime.Now.AddHours(-2.98) },
                new Comment { CommentId = 20, PetId = 4, Auther = "Aviv", Text = "Cute Cat", CreatedDate = DateTime.Now.AddHours(-2.65) },
                new Comment { CommentId = 21, PetId = 11, Auther = "Shira", Text = "Gold fish beautiful", CreatedDate = DateTime.Now.AddHours(-2.38) },
                new Comment { CommentId = 22, PetId = 6, Auther = "Aviv", Text = "Cute Rabbit", CreatedDate = DateTime.Now.AddHours(-1.74) },
                new Comment { CommentId = 23, PetId = 7, Auther = "Shira", Text = "beautiful Macaw", CreatedDate = DateTime.Now.AddHours(-0.93) },
                new Comment { CommentId = 24, PetId = 12, Auther = "Aviv", Text = "Clown fish nice", CreatedDate = DateTime.Now.AddHours(-0.05) }
           );
        }
